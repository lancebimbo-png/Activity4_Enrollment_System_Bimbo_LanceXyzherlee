...
public class CourseFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            // 1. Get the data from your text boxes
            ...
            // 3. The SQL Command for the COURSE table
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            String courseId = model.getValueAt(selectedRow, 0).toString(); // Gets the ID from column 0
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            // Make sure your table's variable name is jTable1 (or change this if you renamed it)
            javax.swing.table.DefaultTableModel model = (javax.swing.table.DefaultTableModel) jTable1.getModel();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            ...
            ps.setString(2, courseDesc);
            ps.setString(3, credits);
            ps.setString(4, courseId); // ID goes last!
